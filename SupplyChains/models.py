...
class MainAttr(models.Model):
    attri = models.CharField(db_column='Attri', max_length=30)  # Field name made lowercase.
    period = models.IntegerField(db_column='Period')  # Field name made lowercase.
    value = models.DecimalField(db_column='Value', max_digits=15, decimal_places=4)  # Field name made lowercase.
...
class MainPara(models.Model):
    username = models.CharField(db_column='Username', max_length=30)  # Field name made lowercase.
    param = models.CharField(db_column='Param', max_length=30)  # Field name made lowercase.
    period = models.IntegerField(db_column='Period')  # Field name made lowercase.
    value = models.DecimalField(db_column='Value', max_digits=15, decimal_places=4)  # Field name made lowercase.
